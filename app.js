...
let filterDateISO = null;       // exact ISO day filter (from Calendar)
...
const donutShadow={id:"donutShadow",beforeDatasetDraw(c){if(c.config.type!=="doughnut")return;const x=c.ctx;x.save();x.shadowColor="rgba(0,0,0,0.35)";x.shadowBlur=14;x.shadowOffsetY=8;},afterDatasetDraw(c){if(c.config.type!=="doughnut")return;c.ctx.restore();}};
